...
class LearnablePositionalEncoding(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        *batch_dims, seq_len, emb_dim = x.shape
        ...
        return positional_emb.expand(*batch_dims, seq_len, emb_dim)

# Create distinct positional encoding classes for the encoder and decoder
class LearnablePositionalEncodingEncoder(LearnablePositionalEncoding):
    pass

class LearnablePositionalEncodingDecoder(LearnablePositionalEncoding):
    pass
...
class MLPEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.positional_encoding = LearnablePositionalEncodingEncoder(n_in, state_dim)
...
class RNNDecoder(nn.Module):
    def __init__(self, 
        ...
        self.positional_encoding = LearnablePositionalEncodingDecoder(n_in, n_in)
